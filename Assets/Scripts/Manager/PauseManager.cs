...
public class PauseManager : MonoBehaviour
{
    ...
    {
        StartCoroutine(IUpdateIsPausedAfterEndOfFrame(true));
    }

    public void UnpauseGame()
    {
        StartCoroutine(IUpdateIsPausedAfterEndOfFrame(false));
    }

    private IEnumerator IUpdateIsPausedAfterEndOfFrame(bool newValue)
    {
